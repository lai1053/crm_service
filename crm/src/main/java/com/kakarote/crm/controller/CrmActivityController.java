...
import com.kakarote.crm.entity.MO.CrmQueryOutworkListMO;
...
public class CrmActivityController {
    ...
    @ApiOperation("外勤签到")
    public Result<CrmActivity> outworkSign(@RequestBody CrmActivity  crmActivity) {
    ...
    public Result<BasePage<CrmActivity>> queryOutworkList(@RequestBody CrmQueryOutworkListMO userData) {
        PageEntity pageEntity = new PageEntity();
        pageEntity.setPageType(0);
        String startTime = userData.getStartTime();
        String endTime = userData.getEndTime();
        long userId = new Long(userData.getUserId());
